...
const clientes = {}; // Objeto para almacenar temporalmente los nombres
...
export function EnviarMensajeWhastapp  (text, number) {
    ...
    if (text.startsWith("mi nombre es ")) {
        const nombre = text.replace("mi nombre es ", "").trim();
        clientes[number] = nombre;
        text = "nombre_guardado";
    }
        ...
        data = JSON.stringify({
            ...
            "text": {
                "preview_url": false,
                "body": `Gracias a ti por contactarme, ${clientes[number]}! 🤩`
            }
        });
    ...
    } else if (text === "nombre_guardado" || !(number in clientes)) {
        data = JSON.stringify({
            "messaging_product": "whatsapp",
            "to": number,
            "type": "text",
            "text": {
                "preview_url": false,
                "body": "Hola! Antes de continuar, ¿puedes decirme tu nombre? Responde con: 'Mi nombre es [tu nombre]'."
            }
        });
        ...
        data = JSON.stringify({
            ...
            "interactive": {
                "type": "button",
                "body": {
                    "text": `👋 Hello! ${clientes[number] || ""} Welcome! Would you like to know more about our products?`
                },
                "footer": {
